...
def read_version():
    version_file = "pycoco/__version__.py"
...
setup(
    ...
    url="https://github.com/Artezaru/pycoco.git",  # URL to the package's homepage
    ...
    package_data={
        'pycoco': ['ressources/*'],  # Include all files in ressources/
    },
    entry_points={
        'console_scripts': [
            'pycoco = pycoco.__main__:main',  # Define the pycoco command to run __main__.main()
        ],
    },
)
